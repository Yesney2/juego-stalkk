...
func _ready() -> void:
	...
	dialogue_res = load("res://dialogues/reportar_correcto.dialogue")
	
	if dialogue_res == null:
		push_error("No se pudo cargar el diálogo: res://dialogues/reportar_correcto.dialogue")
		return
	
	# Desactivar botón hasta que termine el diálogo
	if has_node("newgame"):
...
func _start_dialogue() -> void:
	...
	if balloon:
		...
		push_error("No se pudo crear el balloon en reportar_correcto.")


func _on_dialogue_finished() -> void:
	if has_node("newgame"):
		$newgame.disabled = false
	print("Diálogo de reportar_correcto terminado.")
